...
export var registerExtensionComponent = function (name, component, aliases, type, fieldType) {
    if (aliases === void 0) { aliases = []; }
    if (type === void 0) { type = null; }
    if (fieldType === void 0) { fieldType = ''; }
...
export var getExtensionComponent = function (name) {
    if (extensionRegistry.components[name]) {
        return extensionRegistry.components[name].component;
    }
    return null;
};
export var getExtensionComponents = function (type, fieldType) {
...
export var getExtensionFunction = function (name) {
