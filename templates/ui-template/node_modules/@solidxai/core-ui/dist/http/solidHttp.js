 ...
 */
export var solidAxios = axios.create({
    baseURL: baseURL,
});
solidAxios.interceptors.request.use(function (config) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            case 0:
                if (config.url && config.url.startsWith("/api")) {
                    stripped = config.url.replace(/^\/api(\/|$)/, "/");
                    config.url = stripped === "" ? "/" : stripped;
                }
                return [4 /*yield*/, getSession()];
            case 1:
                session = _b.sent();
                if ((_a = session === null || session === void 0 ? void 0 : session.user) === null || _a === void 0 ? void 0 : _a.accessToken) {
                    config.headers = config.headers || {};
                    config.headers.Authorization = "Bearer ".concat(session.user.accessToken);
                }
                return [2 /*return*/, config];
        }
    });
}); });
solidAxios.interceptors.response.use(function (response) { return response; }, function (error) {
    var _a;
...
export var solidPost = solidAxios.post;
export var solidPut = solidAxios.put;
export var solidPatch = solidAxios.patch;
export var solidDelete = solidAxios.delete;
/**
 ...
 */
//# sourceMappingURL=solidHttp.js.map