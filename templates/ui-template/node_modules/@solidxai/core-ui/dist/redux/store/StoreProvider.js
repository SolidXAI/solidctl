...
function fetchEntities() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, solidGet("/model-metadata/public")];
                case 1:
                    response = _b.sent();
                    data = response === null || response === void 0 ? void 0 : response.data;
                    records = ((_a = data === null || data === void 0 ? void 0 : data.data) === null || _a === void 0 ? void 0 : _a.records) || [];
                    return [2 /*return*/, records.map(function (r) { return r.singularName; })];
            }
        });
    });
}
export function StoreProvider(_a) {
    var children = _a.children, reducers = _a.reducers, middlewares = _a.middlewares;
