...
var SolidDateColumn = function (_a) {
    var _b, _c, _d, _e, _f;
    ...
    var filterTemplate = function (options) {
        ...
        return (_jsx(SolidVarInputsFilterElement, { values: options.value, onChange: function (e) { return options.filterCallback(e, options.index); }, numberOfInputs: numberOfInputs, inputType: InputTypes.Date, solidListViewMetaData: solidListViewMetaData, fieldMetadata: fieldMetadata, column: column }));
    };
    ...
    return (_jsx(Column, { field: fieldMetadata.name, 
        ...
        // filter={filterable}
        dataType: columnDataType, showFilterOperator: showFilterOperator, filterMatchModeOptions: dateFilterMatchModeOptions, filterElement: filterTemplate, filterPlaceholder: "Search by ".concat(fieldMetadata.displayName), 
...
//# sourceMappingURL=SolidDateColumn.js.map