...
export default function PDFViewer(_a) {
    ...
    var _f = useState(null), blobUrl = _f[0], setBlobUrl = _f[1];
    ...
    var goToPrevPage = function () { return setPageNumber(function (p) { return Math.max(p - 1, 1); }); };
    var goToNextPage = function () { return setPageNumber(function (p) { return Math.min(p + 1, numPages); }); };
    if (!url) {
