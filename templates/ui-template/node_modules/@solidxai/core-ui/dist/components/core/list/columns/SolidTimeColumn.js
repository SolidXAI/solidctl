...
var SolidTimeColumn = function (_a) {
    var _b, _c, _d, _e, _f;
    ...
    var filterTemplate = function (options) {
        ...
        return (_jsx(SolidVarInputsFilterElement, { values: options.value, onChange: function (e) { return options.filterCallback(e, options.index); }, numberOfInputs: numberOfInputs, inputType: InputTypes.Time, solidListViewMetaData: solidListViewMetaData, fieldMetadata: fieldMetadata, column: column }));
    };
...
//# sourceMappingURL=SolidTimeColumn.js.map