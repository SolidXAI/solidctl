...
export declare const DefaultDateTimeFormEditWidget: ({ formik, fieldContext }: SolidFormFieldWidgetProps) => import("react/jsx-runtime").JSX.Element;
export declare const DefaultDateTimeFormViewWidget: ({ formik, fieldContext, }: SolidFormFieldWidgetProps) => import("react/jsx-runtime").JSX.Element;
