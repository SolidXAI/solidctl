...
var SolidDateTimeField = /** @class */ (function () {
    function SolidDateTimeField(fieldContext) {
    ...
    Object.defineProperty(SolidDateTimeField.prototype, "updateFormData", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(SolidDateTimeField.prototype, "initialValue", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(SolidDateTimeField.prototype, "validationSchema", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(SolidDateTimeField.prototype, "render", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(SolidDateTimeField.prototype, "renderExtensionRenderMode", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    return SolidDateTimeField;
}());
export { SolidDateTimeField };
export var DefaultDateTimeFormEditWidget = function (_a) {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var formik = _a.formik, fieldContext = _a.fieldContext;
    var _l = useState(false), overlayVisible = _l[0], setOverlayVisible = _l[1];
    ...
    useEffect(function () {
        var handleDocumentClick = function (event) {
            var _a, _b;
            var inputElement = (_a = calendarRef.current) === null || _a === void 0 ? void 0 : _a.getInput();
            var overlayElement = (_b = calendarRef.current) === null || _b === void 0 ? void 0 : _b.getOverlay();
            if (overlayVisible && inputElement && !inputElement.contains(event.target) && overlayElement && !overlayElement.contains(event.target)) {
    ...
    return (_jsxs("div", { className: "relative", children: [_jsxs("div", { className: "flex flex-column gap-2 mt-1 sm:mt-2 md:mt-3 lg:mt-4", children: [showFieldLabel != false &&
                        _jsxs("label", { htmlFor: fieldLayoutInfo.attrs.name, className: "form-field-label", children: [fieldLabel, fieldMetadata.required && _jsx("span", { className: "text-red-500", children: " *" }), _jsx(SolidFieldTooltip, { fieldContext: fieldContext })] }), _jsx("div", { onClick: handleInputClick, id: fieldLayoutInfo.attrs.name, children: _jsx(Calendar, { disabled: formDisabled || fieldDisabled || readOnlyPermission, ref: calendarRef, id: fieldLayoutInfo.attrs.name, "aria-describedby": "".concat(fieldLayoutInfo.attrs.name, "-help"), 
                            ...
                            mask: "99/99/9999 99:99", appendTo: "self", showTime: true, hourFormat: "24", hideOnDateTimeSelect: true, onFocus: function () { return setOverlayVisible(true); }, visible: overlayVisible, onVisibleChange: function (e) {
                                console.log("Overlay visibility changed:", e.visible);
                                setOverlayVisible(e.visible);
                            }, onBlur: function (e) {
                                var _a, _b;
                                if ((_b = (_a = calendarRef.current) === null || _a === void 0 ? void 0 : _a.getOverlay()) === null || _b === void 0 ? void 0 : _b.contains(e.relatedTarget)) {
                                    return;
                                }
                                setOverlayVisible(false);
                            ...
                            } }) })] }), isFormFieldValid(formik, fieldLayoutInfo.attrs.name) && (_jsx("div", { className: "absolute mt-1", children: _jsx(Message, { severity: "error", text: (_k = formik === null || formik === void 0 ? void 0 : formik.errors[fieldLayoutInfo.attrs.name]) === null || _k === void 0 ? void 0 : _k.toString() }) }))] }));
};
export var DefaultDateTimeFormViewWidget = function (_a) {
    var _b, _c, _d;
    var formik = _a.formik, fieldContext = _a.fieldContext;
    var fieldMetadata = fieldContext.fieldMetadata;
    var fieldLayoutInfo = fieldContext.field;
