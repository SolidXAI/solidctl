            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        currentSettings_1 = ((_a = solidSettingsData === null || solidSettingsData === void 0 ? void 0 : solidSettingsData.data) === null || _a === void 0 ? void 0 : _a.user) || {};
                        formData_1 = new FormData();
                        // Compare changed fields
                        Object.entries(values).forEach(function (_a) {
                            var key = _a[0], value = _a[1];
                            var currentValue = currentSettings_1[key];
                            var normalizedCurrent = currentValue !== null && currentValue !== void 0 ? currentValue : "";
                            var normalizedValue = value !== null && value !== void 0 ? value : "";
                            if (normalizedCurrent !== normalizedValue) {
                                if (value instanceof File) {
                                    formData_1.append(key, value);
                                    updatedSettingsArray_1.push({
                                        key: key,
                                        value: "",
                                        type: "user",
                                    });
                        ...
                        formData_1.append("settings", JSON.stringify(updatedSettingsArray_1));
                        return [4 /*yield*/, bulkUpdateSolidSettings({ data: formData_1 }).unwrap()];
                    case 1:
                        response = _b.sent();
