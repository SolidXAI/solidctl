...
var SolidEmailField = /** @class */ (function () {
    function SolidEmailField(fieldContext) {
    ...
    Object.defineProperty(SolidEmailField.prototype, "updateFormData", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(SolidEmailField.prototype, "initialValue", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(SolidEmailField.prototype, "validationSchema", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
            ...
            if (fieldMetadata.regexPattern) {
                var regexPatternNotMatchingErrorMsg = fieldMetadata.regexPatternNotMatchingErrorMsg;
                // Fallback to a user-friendly default for common fields
                if (!regexPatternNotMatchingErrorMsg) {
                    var fieldName = (_b = fieldMetadata.name) === null || _b === void 0 ? void 0 : _b.toLowerCase();
                    if (fieldName === null || fieldName === void 0 ? void 0 : fieldName.includes("email")) {
    ...
    Object.defineProperty(SolidEmailField.prototype, "render", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(SolidEmailField.prototype, "renderExtensionRenderMode", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    return SolidEmailField;
}());
export { SolidEmailField };
export var DefaultEmailFormEditWidget = function (_a) {
