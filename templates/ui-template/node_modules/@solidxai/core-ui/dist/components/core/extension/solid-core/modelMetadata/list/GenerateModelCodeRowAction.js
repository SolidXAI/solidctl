...
var GenerateModelCodeRowAction = function (event) {
    ...
    var _c = useGenerateCodeForModelMutation(), generateCode = _c[0], _d = _c[1], isGenerateCodeUpdating = _d.isLoading, isGenerateCodeSuceess = _d.isSuccess, isGenerateCodeError = _d.isError, generateCodeError = _d.error, generateCodeData = _d.data;
    ...
    //     return false;
    // };
    var generateCodeHandler = function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, generateCode({ id: (_a = event === null || event === void 0 ? void 0 : event.rowData) === null || _a === void 0 ? void 0 : _a.id })];
                case 1:
                    response = _b.sent();
    ...
    var pingBackendWithRetry = function (retries, delay) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, fetch("".concat(env("NEXT_PUBLIC_BACKEND_API_URL"), "/api/ping"))];
                    case 3:
                        res = _a.sent();
                    ...
                    case 4:
                        e_1 = _a.sent();
                        return [3 /*break*/, 5];
                    case 5: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, delay); })];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
    ...
    useEffect(function () {
        var runSeederIfQueueStatusIsSuccess = function () { return __awaiter(void 0, void 0, void 0, function () {
            var isAlive;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!isGenerateCodeSuceess) return [3 /*break*/, 4];
                        return [4 /*yield*/, pingBackendWithRetry()];
                    case 1:
                        isAlive = _a.sent();
                        setIsPinging(false);
                        if (!isAlive) return [3 /*break*/, 3];
                        return [4 /*yield*/, triggerSeeder("ModuleMetadataSeederService")];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
