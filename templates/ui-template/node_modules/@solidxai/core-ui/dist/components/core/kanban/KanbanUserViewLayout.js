...
export var KanbanUserViewLayout = function (_a) {
    var _b;
    var solidKanbanViewMetaData = _a.solidKanbanViewMetaData, setLayoutDialogVisible = _a.setLayoutDialogVisible;
    ...
    if (!((_b = solidKanbanViewMetaData === null || solidKanbanViewMetaData === void 0 ? void 0 : solidKanbanViewMetaData.data) === null || _b === void 0 ? void 0 : _b.solidView))
        return null;
    ...
    var formik = useFormik({
        ...
        onSubmit: function (values) { return __awaiter(void 0, void 0, void 0, function () {
            var parsedLayout, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        parsedLayout = JSON.parse(values.layoutString);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        if (!solidView.id) return [3 /*break*/, 3];
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error(ERROR_MESSAGES.UPDATE_FAILED, error_1);
                        return [3 /*break*/, 5];
...
//# sourceMappingURL=KanbanUserViewLayout.js.map