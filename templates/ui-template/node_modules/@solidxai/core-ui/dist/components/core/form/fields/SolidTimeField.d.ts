...
export declare const DefaultTimeFormEditWidget: ({ formik, fieldContext }: SolidFormFieldWidgetProps) => import("react/jsx-runtime").JSX.Element;
export declare const DefaultTimeFormViewWidget: ({ formik, fieldContext, }: SolidFormFieldWidgetProps) => import("react/jsx-runtime").JSX.Element;
