...
export var SolidVarInputsFilterElement = function (_a) {
    var values = _a.values, onChange = _a.onChange, _b = _a.inputType, inputType = _b === void 0 ? InputTypes.Text : _b, _c = _a.numberOfInputs, numberOfInputs = _c === void 0 ? null : _c, solidKanbanViewMetaData = _a.solidKanbanViewMetaData, fieldMetadata = _a.fieldMetadata;
    if (!values) {
